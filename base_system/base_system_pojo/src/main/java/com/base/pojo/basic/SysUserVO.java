...
public class SysUserVO extends BaseVO {
	...
	public String getSysRoleVOName() {
		return sysRoleVOName;
	}

	public void setSysRoleVOName(String sysRoleVOName) {
		this.sysRoleVOName = sysRoleVOName;
	}
