    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div style="border: 2px solid #eee; padding-top: 5px;" >
                    <div id="sumMain1" style="height:500px;"></div>
                </div>
                <div style="border: 2px solid #eee; padding-top: 5px;" >
                    <div id="sumMain2" style="height:500px;"></div>
                </div>
            </div>
        </div>
    </div>
...
<script src="${ctx}/static/system/echarts/reportrMan/reportrMan.js" type="application/javascript"></script>
</body>
</html>
