...
<script type="text/html" id="toolbarDemo">
    <div class="layui-inline">
        <shiro:hasPermission name="loginlog:del">
            <button class="btn btn-primary bg-main border-color" lay-event="delLoginLog"><i
...
<table class="layui-hide" id="loginLogTable" lay-filter="loginLogFilter"></table>
...
<script src="${ctx}/static/system/log/loginlog/loginlog.js" type="application/javascript"></script>
</body>
</html>
